...
const projects = [
  {
    id: 1,
    title: 'Kasa',
    description: 'Application de location immobilière réalisée avec React, React Router et Sass.',
  ...
  },
  {
    ...
    description: 'API sécurisée permettant de gérer des livres, des utilisateurs et des notes.',
  ...
  },
  {
    id: 3,
    title: 'Nina Carducci',
    description: "Optimisation des performances, du référencement et de l’accessibilité d’un site de photographe.",
